...
func createMetrics(mf monitoring.MetricFactory) {
	queuedCounter = mf.NewCounter("mem_queued_leaves", "Number of leaves queued", []string{logIDLabel})
	dequeuedCounter = mf.NewCounter("mem_dequeued_leaves", "Number of leaves dequeued", []string{logIDLabel})
}
